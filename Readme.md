...
### Foi feito em C# usando o dotnet 5.0 e a IDE visual studio community 2019 e utilizando sql server.
...
### Você conseguirá usar filtros de data e por nome do cliente, caso queira resetar os filtros basta clicar no botão de resetar.
